...
if __name__ == '__main__':
    ...
    parser.add_argument('--tensorrt', action='store_true', help='set Detect() tensorrt=True')   # <---- add by yeah
    ...
    for k, m in model.named_modules():
        if isinstance(m, Conv):  # assign export-friendly activations
            ...
            m.tensorrt = args.tensorrt   # <---- add by yeah
