...
class TRTInference(object):
    ...
    def __init__(self, trt_engine_path, onnx_model_path, trt_engine_datatype=trt.DataType.FLOAT, batch_size=1, \
                    dynamic_shapes={}, calib_data_path=None, calib_file_path=None, input_shape_HW=None):
        ...
        if not os.path.exists(trt_engine_path):
            ...
            self.trt_engine = engine_utils.build_engine(
                ...
                calib_data_path=calib_data_path, calib_file_path=calib_file_path, input_shape_HW=input_shape_HW)
